 ...
 */
public class _1263_MinimumMovesToMoveABoxToTheirTargetLocation {
    ...
    /**
     * BFS search where at each step the S perform one move
     * The state of the search is the position of the box and the position of the storekeeper
     */
    class Solution {
