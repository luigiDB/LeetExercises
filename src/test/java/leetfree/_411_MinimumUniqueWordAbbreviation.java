...
public class _411_MinimumUniqueWordAbbreviation {
    ...
    /**
     * Personal hint
     * given the first word evaluate the possible abbrevitations and startign from the shortest (use a min heap) check
     * if the it's valid for any other word. Repeat until an unique abbeviation is found.
     */
}
