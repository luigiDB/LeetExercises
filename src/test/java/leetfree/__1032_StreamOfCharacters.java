...
public class __1032_StreamOfCharacters {
    ...
    @Test
    public void testMiddleRepetition() {
        StreamChecker streamChecker = new StreamChecker(new String[]{"ab", "cabc"});
        Assert.assertFalse(streamChecker.query('a'));
        Assert.assertTrue(streamChecker.query('b'));
    }

    @Test
    public void testWithRepeatedWords() {
        String[] input = new String[]{"qeahxdiau", "scouf", "wyrrf", "ajrokz", "waesqsboaa", "ylcroakyrz", "fqsujrkzly", "mqund", "vydmgdotw", "nwfprhiz"};
        StreamChecker streamChecker = new StreamChecker(new String[]{"ab", "cabc"});
        Assert.assertFalse(streamChecker.query('x'));
        Assert.assertFalse(streamChecker.query('e'));
        Assert.assertFalse(streamChecker.query('v'));
        Assert.assertFalse(streamChecker.query('u'));
        Assert.assertFalse(streamChecker.query('o'));
        Assert.assertFalse(streamChecker.query('k'));
        Assert.assertFalse(streamChecker.query('u'));
        Assert.assertFalse(streamChecker.query('y'));
        Assert.assertFalse(streamChecker.query('b'));
        Assert.assertFalse(streamChecker.query('c'));
        Assert.assertFalse(streamChecker.query('l'));
        Assert.assertFalse(streamChecker.query('d'));
        Assert.assertFalse(streamChecker.query('m'));
        Assert.assertFalse(streamChecker.query('z'));
        Assert.assertFalse(streamChecker.query('x'));
        Assert.assertFalse(streamChecker.query('e'));
        Assert.assertFalse(streamChecker.query('b'));
        Assert.assertFalse(streamChecker.query('s'));
        Assert.assertFalse(streamChecker.query('v'));
        Assert.assertFalse(streamChecker.query('s'));
        Assert.assertFalse(streamChecker.query('y'));
        Assert.assertFalse(streamChecker.query('k'));
        ...
        Assert.assertFalse(streamChecker.query('d'));
        Assert.assertFalse(streamChecker.query('h'));
        Assert.assertFalse(streamChecker.query('t'));
        Assert.assertFalse(streamChecker.query('d'));
        Assert.assertFalse(streamChecker.query('g'));
        Assert.assertFalse(streamChecker.query('x'));
        Assert.assertFalse(streamChecker.query('r'));
        Assert.assertFalse(streamChecker.query('g'));
        Assert.assertFalse(streamChecker.query('i'));
        Assert.assertFalse(streamChecker.query('y'));
        Assert.assertFalse(streamChecker.query('v'));
        Assert.assertFalse(streamChecker.query('f'));
        Assert.assertFalse(streamChecker.query('l'));
        Assert.assertFalse(streamChecker.query('f'));
        Assert.assertFalse(streamChecker.query('v'));
        Assert.assertFalse(streamChecker.query('q'));
        Assert.assertFalse(streamChecker.query('r'));
        Assert.assertFalse(streamChecker.query('b'));
        Assert.assertFalse(streamChecker.query('k'));
        Assert.assertFalse(streamChecker.query('s'));
        ...
        Assert.assertFalse(streamChecker.query('s'));
        Assert.assertFalse(streamChecker.query('c'));
        Assert.assertFalse(streamChecker.query('p'));
        Assert.assertFalse(streamChecker.query('a'));
        Assert.assertFalse(streamChecker.query('j'));
        Assert.assertFalse(streamChecker.query('v'));
        Assert.assertFalse(streamChecker.query('t'));
        ...
        Assert.assertFalse(streamChecker.query('f'));
        Assert.assertFalse(streamChecker.query('d'));
        Assert.assertFalse(streamChecker.query('n'));
        Assert.assertFalse(streamChecker.query('y'));
        Assert.assertFalse(streamChecker.query('f'));
        Assert.assertFalse(streamChecker.query('l'));
        Assert.assertFalse(streamChecker.query('u'));
        ...
        Assert.assertFalse(streamChecker.query('d'));
        Assert.assertFalse(streamChecker.query('i'));
        Assert.assertFalse(streamChecker.query('w'));
        Assert.assertFalse(streamChecker.query('r'));
        Assert.assertFalse(streamChecker.query('z'));
        Assert.assertFalse(streamChecker.query('h'));
        Assert.assertFalse(streamChecker.query('e'));
